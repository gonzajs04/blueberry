...
export default function Footer() {
    ...
    return (
        <footer className="footer">
            ...
            {isValidMail == false && (<Mensaje mensaje="It looks like that it is not an email" />)}

            <div className="containerg-datafooter">
                <div className="container-datafooter">
                    <div className="logo-web">
                        <h2>BlueBerry</h2>
                        <p>Find what you desire &copy;{obtenerAño()} - All rights reserved</p>
                    </div>
                    ...
                    <div className="contact-footer">
                        ...
                        <div className="contact-data">
                            <p>Contact us</p>
                            <form>
                                <input type="email" placeholder='tumail@mail.com' name="email" id="email" onChange={(e) => { setEmail(e.target.value) }} />
                    ...
                    <div className="location">
                        ...
                        <div className="descrip-location">
                            <p>You can find us on social networks, we don't have presencial encommends</p>
                        </div>
                    </div>
